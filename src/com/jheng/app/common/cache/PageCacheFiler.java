package com.jheng.app.common.cache;
...
import com.jheng.app.common.util.NullValueUtil;
...
public class PageCacheFiler extends SimplePageFragmentCachingFilter
{
	...
	private void init() throws CacheException
	{
		...
		// patterns =
		// "/goods.htm,/floor.htm,/advert_invoke.htm,error.css,goods.css,groupbuy.css,index.css,integral.css,public.css,seller.css,sparegoods.css,user_phptp.css,user.css,window.css,phone.css,jcarousellite_1.0.1.min.js,jquery.ad-gallery.js,jquery.bigcolorpicker.js,jquery.cookie.js,jquery.fancybox-1.3.4.pack.js,jquery.form.js,jquery.jqzoom-core.js,jquery.KinSlideshow.min.js,jquery.lazyload.js,jquery.metadata.js,jquery.poshytip.min.js,jquery.rating.pack.js,jquery.shop.base.js,jquery.shop.common.js,jquery.shop.edit.js,jquery.validate.min.js,jquery.zh.cn.js,jquery-1.6.2.js,jquery-ui-1.8.21.js,swfobject.js,swfupload.js,swfupload.queue.js";
	...
	FilterNonReentrantException, LockTimeoutException, Exception
	{
		...
		String include_url = NullValueUtil.null2String(request
		...
		if (cacheURLs != null && cacheURLs.length > 0)
		{
			for (String cacheURL : cacheURLs)
			{
				...
				{
					if (include_url.equals(cacheURL.trim()))
					{
						flag = true;
						break;
					}
	...
	protected String calculateKey(HttpServletRequest httpRequest)
	{
		...
		String include_url = NullValueUtil.null2String(httpRequest
				.getAttribute("javax.servlet.include.request_uri"));
		...
		{
			stringBuffer
					.append(NullValueUtil.null2String(httpRequest
							.getAttribute("javax.servlet.include.request_uri")))
					.append(NullValueUtil.null2String(httpRequest
